...
ifeq ($(EVAL_BOARD),USE_MAIN_V2)
 ...
 #UART_DEBUG			= MAIN_V3_DEBUG_FT232
 UART_DEBUG			= MAIN_V3_DEBUG_XBEE
...
STM32PLUS_LIB_DIR = $(STM32PLUS_DIR)/build/small-f4-$(HSE_CLOCK)
STATIC_LIB   	= -lstm32plus-small-f4-$(HSE_CLOCK)
else 
	ifeq ($(STM32PLUS_Fn),STM32PLUS_F429)
		STM32PLUS_LIB_DIR = $(STM32PLUS_DIR)/build/small-f429-$(HSE_CLOCK)
		STATIC_LIB   	= -lstm32plus-small-f429-$(HSE_CLOCK)
	endif
endif
