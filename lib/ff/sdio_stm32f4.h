...
#define __SDIO_STM32F4_H	0x0700
...
/* SDIO-DMA goes fail on transferring large amount of data with I2S-Ciuculer DMA! */
#if defined(SD_DMA_MODE) && (defined(USE_MP3_HELIX) || defined(USE_WAVE_OUT))
 #warning "Changed SDIO mode DMA to FIFO-Polling"
 #undef SD_DMA_MODE
